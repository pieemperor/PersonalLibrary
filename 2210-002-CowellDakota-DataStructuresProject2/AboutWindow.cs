...
//	Description:       Present a user with a window that tells about the project
...
{
    /// <summary>
    /// Partial class to display an About Window with information about the program
    /// </summary>
    partial class AboutWindow : Form
    {
        /// <summary>
        /// Constructor that sets the labels to the information about the project
        /// </summary>
        public AboutWindow()
        {
            InitializeComponent();
        ...
        /// <summary>
        /// When OK button is clicked, close the window
        /// </summary>
